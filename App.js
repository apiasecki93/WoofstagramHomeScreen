...
const woofPostStyles = StyleSheet.create({
  ...
  content: {},
  title: {color: 'white', fontWeight: "bold", fontFamily: 'italic'},
  description: {fontSize: '70%', textAlign: 'center', color: 'white'},
});
...
const HomeScreen = () => (
  <ScrollView>
    ...
    <ScrollView style={{flex: 1,flexDirection: 'row',padding: 1}}>
...
const App = () => (
  <SafeAreaView style={{ flex: 1, backgroundColor: '#189B23' }}>
    <HomeScreen />
  </SafeAreaView>
);
